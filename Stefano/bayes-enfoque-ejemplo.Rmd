...
traceplot_params<-traceplot(fit,pars=c("beta0_y1","beta1_y1","sigma_y1","beta0_y2","beta1_y2"))
ggsave(traceplot_params, 
        filename = "Plots/traceplot_params.jpeg",
        device = "jpeg",
        height = 6, width = 10, units = "in")



traceplot_bioage<-traceplot(fit,pars=c("bioage"))
ggsave(traceplot_bioage, 
        filename = "Plots/traceplot_bioage.jpeg",
        device = "jpeg",
