...
ll=list(ii)
save(ll,file="example-initchain.RData")

```

```{r}
load(file="example-initchain.RData")
...
# Create the ggplot2 histogram with a light theme
...
traceplot_params<-
traceplot(fit,pars=c("beta0_y1","beta1_y1","sigma_y1","beta0_y2","beta1_y2"),ncol=5)+ theme(text=element_text(size=15))+ theme(axis.text.x = element_text(angle=90))+ theme(legend.text=element_text(size=15))
...
traceplot_bioage<-traceplot(fit,pars=c("bioage"),ncol=5)+ theme(text=element_text(size=15))+ theme(axis.text.x = element_text(angle=90))+ theme(legend.text=element_text(size=15))
