...
```{r}
yl=range(dat[c("bioage", "true.bioage", "bioage.inf", "bioage.sup")])
...
```{r}
bioage.corr=extract(fit,pars="bcorr")$bcorr
ic=round(apply(bioage.corr,2,quantile,p=c(0.025,0.5,0.975)),1)
bioage.inf=age+ic[1,]
bioage.sup=age+ic[3,]
yl=range(dat[c("bioage", "bioage.inf", "bioage.sup")])
plot(1:n,dat$true.bioage,pch=19,col=1,ylim=yl,xlab="individual")
segments(1:n,bioage.inf,1:n,bioage.sup,col=2)
points(1:n,dat$bioage,col=2)
points(1:n,age,col=3)
legend("bottom",col=1:3,pch=19,c("Real Bioage","Estimated Bioage",'Real age'))
